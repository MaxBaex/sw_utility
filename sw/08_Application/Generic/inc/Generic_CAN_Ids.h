 ...
 */
  ...
  enum CAN_PACKAGE_IDs
  {
    ...
    c_CID_KSB_GPS_Sats         = 0x10a,    //!< uin8_t No of Sats, Fix-Type NO=0 2D=1 3D=2 RTK=3
    ...
    c_CID_A57_Signal           = 0x30b,    //!< uint8_t signal_id +
                                           //!< uint8_t signal_volume

    c_CID_A57_Audio            = 0x30c,    //!< int16_t  audio_frequency +
                                           //!< uint16_t interval +
                                           //!< uint8_t  audio-volume +
                                           //!< uint8_t  duty cycle
                                           //!< uint8_t  climb-mode

    c_CID_A57_Flaps_Status     = 0x30d,    //!< uint8_t  0/1 on/off-switch
                                           //!< uint8_t  CurrentFlapsSetting
                                           //!< uint8_t  OptimalFlapsSetting
                                           //!< uint8_t  FlapsFlashControl
                                           //!< uint8_t  LEDDutyCycle in %

    c_CID_A57_Reboot           = 0x30e,    //!< empty package, just a trigger
